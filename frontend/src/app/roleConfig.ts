// frontend/src/app/roleConfig.ts
export type UserRole = "PUBLIC_USER" | "INVESTIGATOR" | "FORENSIC_ANALYST" | "COURT" | "ADMIN";

export const RESTRICTED_ROLES: UserRole[] = ["INVESTIGATOR", "FORENSIC_ANALYST", "COURT", "ADMIN"];
...
export const ROLE_INFO: Record<UserRole, { name: string; description: string; color: string }> = {
  ...
  ADMIN: { name: "Administrator", description: "System administration and user management", color: "#10b981" },  // ← ADD THIS
};