export type UserRole = "PUBLIC_USER" | "INVESTIGATOR" | "FORENSIC_ANALYST" | "COURT" | "PUBLIC_AUDITOR";
...
export const ROLE_INFO: Record<UserRole, { name: string; description: string; color: string }> = {
  ...
  PUBLIC_AUDITOR: { name: "Public Auditor", description: "Verify system transparency", color: "#10b981" }
};